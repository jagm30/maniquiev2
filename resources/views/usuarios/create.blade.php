...
@section("contenidoprincipal")
	<div class="row">
        <!-- left column -->
        <form name="form1" id="form1" role="form" method="post" action="/usuarios"  enctype="multipart/form-data" >
        @csrf
        <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="name" name="name" required placeholder="Nombre completo">
                    </div>
                  </div>
                  <div class="col-xs-6">
                    <div class="form-group">
